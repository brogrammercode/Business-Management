...
Stream<BusinessParams> _combineBusinessStreams(BusinessModel business) {
    ...
    return rx.Rx.combineLatest4(
      ...
      employeesStream,
      requestsStream,
      (List<EmployeeParam> owners, List<EmployeeParam> admins,
          List<EmployeeParam> employees, List<EmployeeParam> requests) {
    ...
    for (String uid in uids) {
      ...
      final employeeStream = _employeeCache[uid]!.switchMap((employee) {
        ...
        return rx.Rx.combineLatest2(
          salariesStream,
          tracksStream,
          (List<SalaryModel> salaries, List<TrackModel> tracks) {
